  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (values.sendInvite && selectedRole) {
    ...
    >
      <div className="flex flex-col gap-4">
          ...
          <div className="flex items-start">
            ...
            <div className=" flex flex-col ml-2">
              ...
              <p className="text-[#5E6C84]">
                Fill out some basic information about who you&quot;re adding as
                a user
              </p>
            </div>
          </div>
          <ButtonFromTheme
            className="border border-solid border-[#17355D] rounded-md my-2.5 px-10 text-[#17355D] hover:border-[#BA2025] hover:bg-[#BA2025] hover:text-white"
            onClick={() => router.back()}
          >
            Cancel
          </ButtonFromTheme>
        ...
        <div className={groupFieldClass}>
          <h2 className="font-bold">New User Details</h2>
        ...
        <div className="flex gap-4 px-4">
          <ButtonFromTheme
            ...
            className="hover:cursor-pointer text-white py-2 px-8 rounded-md"
          >
            Create User
          </ButtonFromTheme>
          <ButtonFromTheme
