...
const Card = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="card w-full border border-rounded dark:bg-backgroundColor dark:border-gray-600">
      {children}
    </div>
  );
};
...
const Footer = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="card-actions justify-end dark:border-gray-600 p-2 border-t bg-gray-50 dark:bg-backgroundColor">
      {children}
    </div>
  );
};
