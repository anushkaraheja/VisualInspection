...
function changeUrlPort(urlString: string, newPort: string | number): string {
...
const LiveStream = ({ webvis_url }: { webvis_url: string }) => {
    ...
    const { data: latestEntry, isLoading, isError } = useGetLatestEntry(changeUrlPort(webvis_url, 8002));
