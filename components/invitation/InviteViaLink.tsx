    ...
    <form onSubmit={formik.handleSubmit} method="POST" className="pt-4">
      ...
      <div className="flex gap-1">
        <Input
          ...
          placeholder="Restrict domain: brickredsys.com"
          className="text-sm w-1/2 dark:bg-surfaceColor dark:border-surfaceColor"
        />
        <select
          className="select-bordered select rounded dark:bg-surfaceColor dark:border-surfaceColor"
          name="role"
          onChange={formik.handleChange}
      ...
      <p className="text-sm text-slate-500 dark:text-textColor my-2">
